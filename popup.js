const data = [
  {
    projectName: 'Chat AI',
    projectDesktop: 'Chat AI',
    technology: 'Back End Dev',
    image: 'images/chatpop.png',
    desktopImage: 'images/todo.png',
    description: 'What do you do? "I help people solve problems and achieve their goals".',
    languages: ['Javascript', 'Node Js', 'Express'],
    desktopLanguages: ['Javascript', 'Node Js', 'Express'],
    link1: 'https://grace-ai.vercel.app/',
    link2: 'https://github.com/gracekabaghe/grace-ai',
    desktopLink1: 'https://grace-ai.vercel.app/',
    desktopLink2: 'https://github.com/gracekabaghe/grace-ai',
  },
  {
